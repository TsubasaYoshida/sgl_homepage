class EventOneDaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_one_day.save
        format.html {redirect_to "/event_infos/#{@event_one_day.event_info_id}/one_days_management", notice: '日程情報の追加に成功しました。'}
  ...
  def update
    respond_to do |format|
      if @event_one_day.update(event_one_day_params)
        format.html {redirect_to "/event_infos/#{@event_one_day.event_info_id}/one_days_management", notice: '日程情報の更新に成功しました。'}
  ...
  def destroy
    ...
    respond_to do |format|
      format.html {redirect_to "/event_infos/#{@event_one_day.event_info_id}/one_days_management", notice: '日程情報の削除に成功しました。'}
